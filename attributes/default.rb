...
default['goiardi']['install_method'] = 'package'
...
default['goiardi']['index_file'] = "#{node['goiardi']['rundir']}/goiardi-index.bin"
default['goiardi']['data_file'] = "#{node['goiardi']['rundir']}/goiardi-data.bin"
