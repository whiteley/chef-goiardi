...
default["goiardi"]["index_file"] = "#{node["goiardi"]["confdir"]}/goiardi-index.bin"
default["goiardi"]["data_file"] = "#{node["goiardi"]["confdir"]}/goiardi-data.bin"
default["goiardi"]["lfsdir"] = "#{node["goiardi"]["confdir"]}/file_checksums"
